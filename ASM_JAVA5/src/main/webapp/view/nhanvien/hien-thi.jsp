    ...
    <div>
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td class="text-center">Tên đệm</td>
                <td class="text-center">Họ</td>
            ...
            <tbody>
            <c:forEach items="${nhanvien}" var="cs">
                <tr>
                    <th class="text-center">${cs.id}</th>
                    <th class="text-center">${cs.ma}</th>
                    <th class="text-center">${cs.ten}</th>
                    <th class="text-center">${cs.tenDem}</th>
                    <th class="text-center">${cs.ho}</th>
                    <th class="text-center">${cs.gioiTinh}</th>
                    <th class="text-center">${cs.ngaySinh}</th>
                    <th class="text-center">${cs.diaChi}</th>
                    <th class="text-center">${cs.sdt}</th>
                    <th class="text-center">${cs.matKhau}</th>
                    <th class="text-center">${cs.trangThai}</th>
