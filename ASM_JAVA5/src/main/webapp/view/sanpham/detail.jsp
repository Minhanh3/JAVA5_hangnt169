...
<div class="content ">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 mt-5">
        ...
        <a href="/san-pham/add" class="btn btn-success">Thêm mới</a>
    </div>
    <div class="mb-3">
    ...
    <div>
        ...
        <div class="card">
            <div class="card-header">
                ${chiTietSp.sanPham.ten}
            </div>
            <div class="card-body">
                <h5 class="card-title">Mã: ${chiTietSp.sanPham.ma}</h5>
                <p class="card-text"><strong>Nhà Sản Xuất:</strong> ${chiTietSp.nsx.ten}</p>
                <p class="card-text"><strong>Màu Sắc:</strong> ${chiTietSp.mauSac.ten}</p>
                <p class="card-text"><strong>Dòng Sản Phẩm:</strong> ${chiTietSp.dongSp.ten}</p>
                <p class="card-text"><strong>Năm Bảo Hành:</strong> ${chiTietSp.namBh}</p>
                <p class="card-text"><strong>Mô Tả:</strong> ${chiTietSp.moTa}</p>
                <p class="card-text"><strong>Số Lượng Tồn:</strong> ${chiTietSp.soLuongTon}</p>
                <p class="card-text"><strong>Giá Nhập:</strong> ${chiTietSp.giaNhap}</p>
                <p class="card-text"><strong>Giá Bán:</strong> ${chiTietSp.giaBan}</p>
            </div>
        </div>
        <a href="/san-pham/hien-thi" class="btn btn-primary mt-3">Back to List</a>
...
<%--            </thead>--%>
<%--            <tbody>--%>
<%--            <c:forEach items="${sanPham}" var="cs">--%>
<%--                <tr>--%>
<%--                    <th class="text-center">${cs.id}</th>--%>
<%--                    <th class="text-center">${cs.ma}</th>--%>
<%--                    <th class="text-center">${cs.ten}</th>--%>
<%--                    <th class="text-center">--%>
<%--                        <a href="/san-pham/detail/${cs.id}">--%>
<%--                            <button class="btn btn-primary btn-sm">Detail</button>--%>
<%--                        </a>--%>
<%--                        <a href="/san-pham/view-update/${cs.id}">--%>
<%--                            <button class="btn btn-primary btn-sm">Update</button>--%>
<%--                        </a>--%>
<%--                        <a href="/san-pham/remove/${cs.id}">--%>
