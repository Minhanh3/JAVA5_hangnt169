...
<div class="container mt-5">
    ...
    <form action="/dong-SP/add" method="post" class="mb-4">
        <div class="mb-3">
    ...
    <table class="table table-hover table-bordered">
        ...
        <c:forEach items="${list}" var="dsp">
            <tr>
                ...
                <td>${dsp.ma}</td>
                <td>
                    <a href="/dong-SP/delete/${dsp.id}" class="btn btn-danger btn-sm me-2">Delete</a>
                    <a href="/dong-SP/update/${dsp.id}" class="btn btn-warning btn-sm">Update</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
